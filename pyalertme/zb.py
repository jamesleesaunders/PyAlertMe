...
messages = {
    'version_info_request': {
        ...
        'frame': {
            ...
            'data': lambda self, params: ZB.generate_version_info_request(self, params)
        }
    },
    'version_info_update': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_version_info_update(self, params)
        },
    ...
    'range_update': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_range_update(self, params)
        },
    ...
    'switch_state_request': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_switch_state_request(self, params)
        },
    ...
    'switch_state_update': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_switch_state_update(self, params)
        }
    },
    'mode_change_request': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_mode_change_request(self, params)
        },
    ...
    'status_update': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_status_update(self, params)
        }
    },
    'power_demand_update': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_power_demand_update(self, params)
        }
    },
    'power_consumption_update': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_power_consumption_update(self, params)
        }
    },
    'button_press': {
        'name': 'Button Press',
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_button_press(self, params)
        }
    },
    'security_init': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ALERTME,
            'dest_endpoint': ENDPOINT_ALERTME,
            'data': lambda self, params: ZB.generate_security_init(self, params)
        }
    },
    'active_endpoints_request': {
        ...
        'frame': {
            ...
            'data': lambda self, params: ZB.generate_active_endpoints_request(self, params)
        }
    },
    'match_descriptor_request': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ZDO,
            'dest_endpoint': ENDPOINT_ZDO,
            'data': lambda self, params: ZB.generate_match_descriptor_request(self, params)
        }
    },
    'match_descriptor_response': {
        ...
        'frame': {
            ...
            'src_endpoint': ENDPOINT_ZDO,
            'dest_endpoint': ENDPOINT_ZDO,
            'data': lambda self, params: ZB.generate_match_descriptor_response(self, params)
        }
    },
